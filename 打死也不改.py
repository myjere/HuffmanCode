...
def compressfile(inputfile,fileafterrle):
    ...
    encode(False)
    print("编码完成！")
    #5.写入前准备，根据字符最高出现频率确定写入文件中所占空间，创建文件
	...
	o.write(int.to_bytes(writewidth ,1 ,byteorder = 'big'))			#写出编码表字节宽度
...
7.文件解压
'''
def decompress(inputfile,fileafterrle):
    print("开始解压！")
    #1.进行哈夫曼编码的解压
